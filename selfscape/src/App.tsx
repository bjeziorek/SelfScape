...
const addNode = () => { const id = (nodes.length + 1).toString(); setNodes((nds) => [ ...nds, { id, type: 'mapNode', position: { x: Math.random() * 400, y: Math.random() * 400, }, data: { label: `Node ${id}` }, }, ]); };
  return (
    <>
...
>
  ...
  <Controls />
          ...
          {/* </div> */}
          <div style={{ width: '100vw', height: '100vh' }} onMouseDown={() => console.log('mousedown wrapper')}> 
